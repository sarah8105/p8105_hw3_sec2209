...
In this next code chunk, I create a two-panel plot showing `tmax` and `tmin` for the full data set and a plot showing the distribution of snowfall values great than 0 and less than 100 separately by year.
