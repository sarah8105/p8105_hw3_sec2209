...
From this graph, we can see that average maximum temperatures in July are much higher than temperatures in January as expected. There is a wider range and more outliers in the January temperatures across NY NOAA stations than in the July termperatures. The trend in average maximum temperatures in January also shows greater fluctuation year-to-year than the average maximum temperatures in July.
...
plot_snow = noaa %>%
  ...
  scale_x_discrete(
    ...
    labs(
      ...
      x = "Year",
      y = "Snowfall",
      caption = "Including snowfall greater than 0 and less than 100mm."
    )

plot_temp / plot_snow
```

From this graph, we can see that the distribution in minimum and maximum temperatures are offset by approximately 10-15 degrees Celcius. The distribution in snowfall is relatively consistent across the years.
